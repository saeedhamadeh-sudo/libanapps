...
> **v7:** شغّل `db/upgrade-store-v7.sql` (تحكم أعمق: عنوان مخصّص وعدد عناصر لأقسام التصنيفات، وصل حديثاً، أحدث المنتجات — من تبويب «الثيم والمظهر» ← «أقسام الصفحة الرئيسية» ← سهم ▸ بجانب القسم). آخر استعلام سطر true.
